        ...
        <div class="col-lg-10 col-offset-lg-1 mx-auto">
          <div class="contact-info bg-white">
            <div class="contact-info-title text-center mb-4 px-5">
              ...
              <p class="mb-0">Sagittis posuere id nam quis vestibulum vestibulum a facilisi at elit hendrerit
                scelerisque sodales nam dis orci.</p>
            </div>
                ...
                <div class="info-item bg-lgrey px-4 py-5 border-all text-center rounded">
                  ...
                  <div class="info-content ps-4">
                    ...
                    <p class="m-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                        data-cfemail="4b22252d240b392e2a273823222e272f65282426">[email&#160;protected]</a></p>
                    <p class="m-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                        data-cfemail="452d2029350537202429362d2c2029216b262a28">[email&#160;protected]</a></p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-lg-4 col-md-6 col-sm-12 mb-4 pe-4">
                  <div class="footer-about">
                      ...
                      <ul>
                          ...
                          <li class="white"><a href=""><i class="fa-sharp fa fa-envelope" aria-hidden="true"></i></a>
                               <a
                                  href="" class="__cf_email__"
                                  data-cfemail="">info@H-motor.com</a>
                          </li>
                          <li class="white"><a href=""><i class="fa-duotone fa-browse" aria-hidden="true"></i></a>
          ...
          <div class="copyright-inner rounded p-3 d-md-flex align-items-center justify-content-between">
              ...
              <div class="social-links">
                  <ul>
                      ...
                      <li><a href="#"><i class="fab fa-tripadvisor" aria-hidden="true"></i></a></li>
          ...
          <ul class="nav nav-tabs nav-pills nav-fill" id="postsTab" role="tablist">
            <li class="nav-item" role="presentation">
              <button aria-controls="login" aria-selected="false" class="nav-link active" data-bs-target="#login"
                data-bs-toggle="tab" id="login-tab" role="tab" type="button">Login</button>
            </li>
            <li class="nav-item" role="presentation">
              <button aria-controls="register" aria-selected="true" class="nav-link" data-bs-target="#register"
                data-bs-toggle="tab" id="register-tab" role="tab" type="button">Register</button>
            </li>
          </ul>
                ...
                <div class="col-lg-6">
                  ...
                  <form method="post" action="#" name="contactform1" id="contactform1">
                    ...
                    <div class="form-group mb-2 d-flex">
                      ...
                      <label class="custom-control-label mb-0 ms-1 lh-1" for="exampleCheck1">I have read and accept the
